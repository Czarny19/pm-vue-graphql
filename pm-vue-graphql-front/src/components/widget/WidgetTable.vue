<template>
  <v-data-table :headers="tableHeaders" :items="queryData"/>
</template>

<script lang="ts">
import Vue from "vue";
import {GET_QUERY_BY_ID} from "@/graphql/queries/query";
import {AppWidget, Query} from "@/plugins/types";
import {getArgsProps, getCssProps} from "@/plugins/widget";
import {generateQuery, runQuery} from "@/plugins/query";
